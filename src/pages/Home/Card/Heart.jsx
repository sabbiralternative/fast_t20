        ...
        <div className="absolute bottom-0.5 right-0.5 w-[70%]">
          ...
          >
            <defs>
              <path
                id="a"
                d="M9 8.6c12.2-11.8 34-11.8 44 2a11 11 0 0 1 1.9 3.9h2.6a8 8 0 0 1 2-3.9C70.4-2.8 91.6-2.8 103.6 9L25 73.3A347 347 0 0 1 8.3 53.1C-2.7 38.4-3.2 20.4 9 8.6"
              />
            </defs>
            <g fill="none" transform="translate(0 4)">
              <path
                fill="#EC5148"
                d="M58.5 101.6c9.7-9 34.4-34.9 44-46.5 10.5-12.5 14-32.5 2.1-45.2-11.8-12.6-33.8-13-45.2.7a8 8 0 0 0-1.9 3.9H55a11 11 0 0 0-1.8-3.9C42.9-3.2 21-3.2 9 8.6-3.3 20.4-2.7 38.4 8.2 53a566 566 0 0 0 43.2 48.5c1.6 1.6 5.4 1.5 7 0z"
              />
