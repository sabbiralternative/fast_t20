        ...
        <div className="absolute bottom-0.5 right-0.5 w-[70%]">
          ...
          >
            <defs>
              <path
                id="a"
                d="M55.7 1.2C62 7 72.5 18.3 82 29L9.4 88.3l-1.7-1.6C-3.5 75.2-1.8 58 8.3 45.6 17 35 39.4 11.8 51.2 1c1.5-1.4 3-1.3 4.5.2"
              />
            </defs>
            <g fill="none" fillRule="evenodd" transform="translate(5)">
              <path
                fill="#201D2D"
                d="M51 95.7c.7-.6 1.4-.5 2.1 0 3 2.5 10.2 9 18 16.5.3.3 0 .9-.4.9l-38-.3c-.5 0-.6-.7-.3-1C40 105 48.1 98.3 51.1 95.6zM51.3 1c1.5-1.4 3-1.3 4.5.2A554 554 0 0 1 97 47c10.7 13.7 10.9 30-.7 41.1-11.5 11.2-32.4 11.2-41-.7-.9-1-1.5-2.3-1.8-3.6H51a7.5 7.5 0 0 1-1.8 3.6C39.7 97.6 19 98.2 7.8 86.7s-9.5-28.7.6-41.1C17 35 39.4 11.8 51.2 1z"
              />
              <use xlinkHref="#a" fill="#FFF" opacity="0.1" />
            </g>
          </svg>
        </div>
